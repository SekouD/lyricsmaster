...
The sources for LyricsMaster can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/SekouD/lyricsmaster
.. _tarball: https://github.com/SekouD/lyricsmaster/tarball/master
