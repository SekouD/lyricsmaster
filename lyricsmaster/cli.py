...
@click.option('--provider', default='LyricWiki', help='Lyrics Provider.', type=click.STRING)
@click.option('--album', default=None, help='Album.', type=click.STRING)
@click.option('--song', default=None, help='Song.', type=click.STRING)
@click.option('--folder', default=None, help='Folder where the lyrics will be saved.', type=click.STRING)
